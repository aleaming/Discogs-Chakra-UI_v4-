...
import { ChevronDown, Calendar, Globe, Users, History, Ticket, MapPin } from 'lucide-react';
            ...
            <TabPanels>
              <TabPanel p={0}>
                <VStack spacing={6} align="stretch">
                  <HStack justify="space-between" wrap="wrap" spacing={4}>
                    <Box>
                      <Heading size="lg" mb={2}>All Tour Dates</Heading>
                      <Text color={textColor}>
              ...
              <TabPanel p={0}>
                <HStack mb={8} justify="space-between" wrap="wrap" spacing={4}>
                  <Box>
                    <Heading size="lg" mb={2}>Tour History</Heading>
                    <Text color={textColor}>
